...
CLI.prototype.do_cmyk_to_xy = require('./commands/cmyk-to-xy');
CLI.prototype.do_hsl_to_xy = require('./commands/hsl-to-xy');
CLI.prototype.do_rgb_to_xy = require('./commands/rgb-to-xy');
